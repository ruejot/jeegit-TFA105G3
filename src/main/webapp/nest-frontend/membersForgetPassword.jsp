			...
			<div class="card">
				...
				<div class="card-body">
					<form method="post" name="enq"
						action="<%=request.getContextPath()%>/members/MembersForgetPassword">
						<div class="form-group col-md-6"></div>
	
						<div class="row">
	
							<div class="form-group col-md-12">
								<h6>請您輸入註冊時的帳號E-mail，將會發送臨時密碼至註冊的E-mail!</h6>
	
							</div>
	
							<div class="form-group col-md-12">
								<label>請輸入註冊的email</label>
								<input required="required" class="form-control" 
									name="membersEmail" type="text" placeholder="請輸入註冊的e-mail" />								
							</div>
