...
// Integer busid =  Integer.parseInt(request.getParameter("meridFromShopMainPage"));
// (Integer)request.getAttribute("meridFromShopMainPage");
// Integer.parseInt(req.getParameter("caseid"));

// BusService busSvc = new BusService();
// BusVO busVO = busSvc.select(busid);
// CsDetailVO csDetailVO = (CsDetailVO) request.getAttribute("csDetailVO_z");

// MembersVO membersVO = membersSvc.select(memberid)
// (MembersVO) session.getAttribute("MemberUsing");
%>
											...
											<div class="row">
												<div class="col-lg-6 col-md-6">
													...
													<div class="input-style mb-20">
														<input type="text" readonly name="memberName" value="${membersVO_thisPage.name}" placeholder="會員名稱" />
													</div>
												</div>
												<div class="col-lg-6 col-md-6">
													<div class="text ml-20">
													...
													<div class="input-style mb-20">
														<input type="email" readonly name="memberEmail" value="${membersVO_thisPage.email}" placeholder="電子信箱" />
													</div>
												</div>
												<div class="col-lg-6 col-md-6">
													<div class="text ml-20">
												...
												<div class="col-lg-6 col-md-6">
													...
													<div class="input-style mb-20">
														<input type="text" readonly name="case_time" id="today" placeholder="回報時間" />
													</div>
												</div>
												<div class="col-lg-6 col-md-6">
													<div class="input-style mb-20">
