        ...
        <main class="main-wrap">
            <section class="content-main">
                <div class="content-header">
                    ...
                    <div>
                        <a href="<%=request.getContextPath()%>/views/blog_add-article.jsp" class="btn btn-primary btn-sm rounded">新增文章</a>
                    </div>
                </div>
                <div class="card mb-4">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-4 col-sm-4 col-8 flex-grow-1 col-name">
                                    <a class="itemside" href="#">
                                        <div class="left">
                                            <img src="<%= request.getContextPath() %>/assets/imgs/items/1.jpg" class="img-sm img-thumbnail" alt="Item" />
                                        </div>
                                        <div class="info">
