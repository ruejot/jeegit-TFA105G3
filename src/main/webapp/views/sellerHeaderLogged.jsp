<!-- 為了跟會員打招呼而import相關資訊 -->
<%@page import="com.bus.model.BusVO"%>

<!-- 以下sellerHeader跑版，所以尚待改 -->
						...
						<div class="header-action-right">
							<div class="header-action-2">
								<div class="header-action-icon-2">
									<a href="xxxx.html"><span class="lable">
...
<!-- 我加了form標籤-->	<form action="../bus/BusLogout" method="POST">
...
<!--我有修改登出的a標籤超連結到登入頁-->		<li><a href="busLogin.jsp">
			...
			<div class="container">
				<div class="header-wrap header-space-between position-relative">
					<div class="logo logo-width-1 d-block d-lg-none">
						<a href="index.html">
						<img src="<%=request.getContextPath()%>/assets/imgs/theme/logo_Petting.svg" alt="logo" /></a>
					</div>
					<div class="header-nav d-none d-lg-flex">
						<div class="main-categori-wrap d-none d-lg-block">
							<a class="categories-button-active" style="background-color: #386641;" href="#"> <span
						...
						<div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
							<nav>
								<ul>
									...
									<a href="shop-grid-right.html">熱門商品</a>
									</li>
									<li>
					...
					<div class="header-action-right d-block d-lg-none">
						<div class="header-action-2">
								<div class="header-action-icon-2">
									<a href="xxxx.html"><i class="far fa-folder-open fa-lg mr-10" style="color: black"></i></a>
								</div>
								<div class="header-action-icon-2">
									<a href="page-account.html"><img class="svgInject" alt="Account" src="<%=request.getContextPath()%>/assets/imgs/theme/icons/icon-user.svg" /></a>
								</div>
						</div>
					</div>
				</div>
