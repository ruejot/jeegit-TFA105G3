...
MemArtPicService artpicSvc = new MemArtPicService();
List<MemArtPicVO> list2 = artpicSvc.getAll();
                                    ...
                                    <article class="first-post mb-30 hover-up animated" style="visibility: visible">
                                        ...
                                        <div class="entry-content">
                                            <h2 class="post-title mb-20">
                                                <a href="blog-post-right.html">${memBlogArtVO.title}</a>
                                            </h2>
                                            ...
                                            <div class="mb-20 entry-meta meta-2">
                                                ...
                                                <a href="blog-post-right.html" class="btn btn-sm">更多...<i class="fi-rs-arrow-right ml-10"></i></a>
                                            </div>
                                        </div>
                                    </article>
                                    </c:forEach>
                        ...
                        <div class="col-lg-12">
                            <div class="position-relative newsletter-inner">
                                <div class="newsletter-content">
                                    <h2 class="mb-20">
                                        在petting.com，你可以為心愛的他/她 <br />
                                        找到所有需要的用品。
                                    </h2>
                                    <p class="mb-45">訂閱電子報，看看我們的熱門文章及推薦商品在 <span class="text-brand">petting.com</span></p>
