								...
								<div class="header-action-2">								
									<div class="header-action-icon-2">
										<a class="mini-cart-icon" href="shop-cart.html">
											<img alt="Cart" src="<%=request.getContextPath()%>/assets/imgs/theme/icons/icon-cart.svg" />
											<span class="pro-count blue">2</span>
										</a>
										<a href="shop-cart.html"><span class="lable">購物車</span></a>
										<div class="cart-dropdown-wrap cart-dropdown-hm2">
											<ul>
												<li>
													<div class="shopping-cart-img">
														<a href="shop-product-right.html"><img alt="Shop" src="<%=request.getContextPath()%>/assets/imgs/shop/thumbnail-3.jpg" /></a>
													</div>
												...
												<li>
													<div class="shopping-cart-img">
														<a href="shop-product-right.html"><img alt="Nest" src="<%=request.getContextPath()%>/assets/imgs/shop/thumbnail-2.jpg" /></a>
													</div>
													<div class="shopping-cart-title">
...
<!-- 我加了form標籤的-->	<form action="../member/memberLogout" method="POST">
...
<!--我有修改登出的a標籤超連結-->					<li><a href="memberLogin.jsp"><i class="fi fi-rs-sign-out mr-10"></i>登出</a>
<!--我有多一行隱形的input標籤-->						<input type="hidden" name="action" value="logout">
												</li>
...
<!-- 我加了form標籤結尾-->		</form>
                    ...
                    <div class="header-wrap header-space-between position-relative">
                        ...
                        <div class="header-nav d-none d-lg-flex">
                            <div class="main-categori-wrap d-none d-lg-block">
                                <a class="categories-button-active" href="#">
                                    <span class="fi-rs-apps"></span> <span class="et">瀏覽所有類別</span>
                                ...
                                <div class="categories-dropdown-wrap categories-dropdown-active-large font-heading">
                                    <div class="d-flex categori-dropdown-inner">
                                        <ul>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="<%=request.getContextPath()%>/assets/imgs/theme/icons/category-1.svg" alt="" />寵物飼料</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="<%=request.getContextPath()%>/assets/imgs/theme/icons/category-2.svg" alt="" />寵物罐頭</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="<%=request.getContextPath()%>/assets/imgs/theme/icons/category-3.svg" alt="" />寵物保健</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="<%=request.getContextPath()%>/assets/imgs/theme/icons/category-4.svg" alt="" />寵物零食</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="<%=request.getContextPath()%>/assets/imgs/theme/icons/category-5.svg" alt="" />寵物玩具</a>
                                            </li>
                                        </ul>
                                        <ul class="end">
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="<%=request.getContextPath()%>/assets/imgs/theme/icons/category-6.svg" alt="" />居家用品</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="<%=request.getContextPath()%>/assets/imgs/theme/icons/category-7.svg" alt="" />外出用品</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="<%=request.getContextPath()%>/assets/imgs/theme/icons/category-8.svg" alt="" />美容護理</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="<%=request.getContextPath()%>/assets/imgs/theme/icons/category-9.svg" alt="" />人氣商品</a>
                                            </li>
                                            <li>
                                                <a href="shop-grid-right.html"> <img src="<%=request.getContextPath()%>/assets/imgs/theme/icons/category-10.svg" alt="" />其他</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                                <nav>
                                    <ul>
                                        <li class="hot-deals">
                                        <img src="<%=request.getContextPath()%>/assets/imgs/theme/icons/icon-hot.svg" alt="hot deals" />
                                        <a href="shop-grid-right.html">熱門商品</a></li>
                                        <li>
                        ...
                        <div class="header-action-right d-block d-lg-none">
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    <a class="mini-cart-icon" href="shop-cart.html">
                                        <img alt="Account" src="<%=request.getContextPath()%>/assets/imgs/theme/icons/icon-cart.svg" />
                                        <span class="pro-count white">2</span>
                                    </a>
                                    
                                    <div class="header-action-icon-2">
                                        <a href="page-account.html">
                                            <img class="svgInject" alt="user" src="<%=request.getContextPath()%>/assets/imgs/theme/icons/icon-user.svg" />
                                        </a>
                                        <a href="page-account.html"><span class="lable ml-0">會員中心</span></a>
                        ...
                        <nav>
                            <ul class="mobile-menu font-heading">
                                <li class="menu-item-has-children">
                                    <a href="index.html">商城首頁</a>
                                </li>
                                <li class="menu-item-has-children">
                                    <a href="shop-grid-right.html">寵物糧食</a>
                                    <ul class="dropdown">
                                        <li><a href="shop-grid-right.html">品牌飼料</a></li>
                                        <li><a href="shop-grid-left.html">貓狗罐罐</a></li>
                                        <li><a href="shop-list-right.html">貓狗零食</a></li>
                                ...
                                <li class="menu-item-has-children">
                                    <a href="blog-category-fullwidth.html">部落格首頁</a>
                                </li>
                                <li class="menu-item-has-children">
                                    <a href="page-contact.html">聯絡我們</a>
                                </li>
                            </ul>
                        </nav>
                        <!-- mobile menu end -->
        ...
        <!-- Template  JS -->
        <script src="<%=request.getContextPath()%>/assets/js/main.js?v=4.0"></script>
