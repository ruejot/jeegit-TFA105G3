...
<head>
<meta charset="utf-8" />
<title>Petting 商業會員密碼修改成功!</title>
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="form-group col-md-12">
							<label>將在<img
								src="http://unicatolicaquixada.edu.br/wp-content/uploads/2019/08/contagem-regressiva-gif-6.gif"
								class="n3VNCb" style="width: 17px; height: 27px; margin: 0px;">秒後自動跳轉至登入頁!再煩請重新登入!!
							</label>
						...
						<meta http-equiv="refresh"
							content="5;url=/jeeweb-TFA105G3/nest-frontend/Login.jsp">
